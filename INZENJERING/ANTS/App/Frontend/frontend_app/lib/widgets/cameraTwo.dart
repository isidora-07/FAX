...
class CameraTwo extends StatefulWidget {
  @override
  _CameraTwoState createState() => _CameraTwoState();
}
...
class _CameraTwoState extends State<CameraTwo>{
  ...
  Widget build(BuildContext context) {
   ...
   final loader = Center(
    ...
    final cameraPhone1 = MaterialButton(
      onPressed: () {
        _openCamera(1);
      },
    ...
    final cameraGalery1 = MaterialButton(
      onPressed: () {
        _openGalery(1);
      },
      color: Color(0xFF00BFA6),
    ...
    // Pick image from your camera live
    final cameraPhone2 = MaterialButton(
      onPressed: () {
        _openCamera(2);
      },
      color: Color(0xFF00BFA6),
    ...
    // Pick image from your gallery
    final cameraGalery2 = MaterialButton(
      onPressed: () {
        _openGalery(2);
      },
      color: Color(0xFF00BFA6),
    ...
    final submitObjavu = RaisedButton.icon(
      ...
      onPressed: () {
        ...
        APIServices.jwtOrEmpty().then((res) {
          ...
          if (imageFile == null || addres == null  || postType == null || imageFile2 == null) {
            setState(() {
              pogresanText = "Potrebno je uneti slike, tip problema i lokaciju.";
            });
            throw Exception('Greskaaaa');
          }
          if (res != null && imageFile != null && imageFile2 != null && addres != null  && postType != null) {
