...
{
    public class SecondArtistDAL : IArtistDAL
    {
        private readonly IConfiguration _configuration;
        private string ConnectionString;
        public SecondArtistDAL(IConfiguration configuration)
        {
        ...
        public bool DeleteArtistByID(int id)
        {
            using (SQLiteConnection connection = new SQLiteConnection(ConnectionString))
            {
                try
                {
                    ...
                    command.CommandText = $"DELETE FROM artist WHERE @id = idArtist";
        ...
        public bool Insert(Artist artist)
        {
            using (SQLiteConnection connection = new SQLiteConnection(ConnectionString))
            {
                try
                {
                    connection.Open();
                    SQLiteCommand command = connection.CreateCommand();
                    command.CommandText = "INSERT INTO artist VALUES (NULL, @nameArtist, @dateArtist, @idBend)";
                    ...
                    parameter.Value = artist.dateArtist.ToString();
                    command.Parameters.Add(parameter);
