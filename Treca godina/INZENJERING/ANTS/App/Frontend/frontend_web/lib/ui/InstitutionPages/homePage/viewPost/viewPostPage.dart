...
import 'package:frontend_web/ui/InstitutionPages/homePage/viewPost/viewPostDesktop.dart';
import 'package:frontend_web/ui/InstitutionPages/homePage/viewPost/viewPostMobile.dart';
...
class ViewPostInsPage extends StatefulWidget {
  
  final FullPost post;
  ViewPostInsPage(this.post);

  @override
  _ViewPostPageState createState() => _ViewPostPageState(post);
}

class _ViewPostPageState extends State<ViewPostInsPage> {
      ...
      builder: (context, sizingInformation) => DefaultTabController(
        ...
        child: Scaffold(
          ...
          body: ScreenTypeLayout(
            mobile: ViewPostInsMobile(post),
            tablet: ViewPostInsDesktop(post),
          ),
        ),
      )
    );
