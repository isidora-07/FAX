...
class ManageAdminDesktop extends StatefulWidget {
  final int id;

  const ManageAdminDesktop(this.id);

  @override
  _ManageAdminDesktopState createState() => _ManageAdminDesktopState();
}
...
class _ManageAdminDesktopState extends State<ManageAdminDesktop>
        ...
        CenteredViewManageUser(
          child: TabBarView(children: <Widget>[
            ...
            Column(children: [
              ...
              Flexible(
                  child: filteredAdmins == null
                      ? buildAdminList(listAdmins)
                      : buildAdminList(filteredAdmins)),
            ]),
          ]),
        ),
